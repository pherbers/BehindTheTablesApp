package de.prkmd.behindthetables.imported.wasabeef;
/*
...
public class MyItemAnimator extends BaseItemAnimator {
    ...
    public MyItemAnimator(Interpolator interpolator) {
...
abstract class BaseItemAnimator extends SimpleItemAnimator {
