...
public class BuildDBTask extends AsyncTask<Void, Void, Boolean> {
	...
	public BuildDBTask(Context context, boolean includeDefaults, boolean includeExternal) {
		this(context, null, includeDefaults, includeExternal);
	}

	public BuildDBTask(Context context, Class callBackTarget, boolean includeDefaults, boolean includeExternal) {
